...
import com.hahnemanntechnology.activities.CartListActivity
...
class MyOrderDetailsListAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder , position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.tv_cart_item_quantity.visibility = View.VISIBLE
            holder.itemView.tv_cart_item_quantity.text = "Quantity(${model.cart_quantity})"
