...
class CheckoutActivity : BaseActivity() {
    ...
    private lateinit var mCartItemsList: ArrayList<CartModel>
    ...
    private lateinit var mOrderDetails: OrderModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // setupActionBar()
        ...
        backArrow_checkoutlist.setOnClickListener { onBackPressed() }

        if (intent.hasExtra(Constant.EXTRA_SELECTED_ADDRESS)) {
            mAddressDetails =
                intent.getParcelableExtra<AddressModel>(Constant.EXTRA_SELECTED_ADDRESS)!!
        }

        if (mAddressDetails != null) {
            tv_checkout_address_type.text = mAddressDetails?.type
            tv_checkout_full_name.text = mAddressDetails?.name
            tv_checkout_address.text = "${mAddressDetails!!.area},${mAddressDetails!!.town}, ${mAddressDetails!!.zipCode}"
            tv_checkout_additional_note.text = mAddressDetails?.landmark
    ...
    fun allDetailsUpdatedSuccessfully() {
       ...
       // Toast.makeText(this@CheckoutActivity, "Your order placed successfully.", Toast.LENGTH_SHORT).show()
        ...
        val intent = Intent(this@CheckoutActivity, OrderPlaced::class.java)
