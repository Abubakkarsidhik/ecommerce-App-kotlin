...
import com.hahnemanntechnology.adapters.CartItemsListAdapter
...
class CartListActivity : BaseActivity() {
    ...
    private lateinit var mProductsList: ArrayList<ProductModels>

    // A global variable for the cart list items.
    private lateinit var mCartListItems: ArrayList<CartModel>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_backArrow.setOnClickListener { onBackPressed() }
     ...
     * @param cartList
     */
    fun successCartItemsList(cartList: ArrayList<CartModel>) {
